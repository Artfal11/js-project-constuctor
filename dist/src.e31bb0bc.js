...
var model = exports.model = [new _blocks.TitleBlock('Конструктор сайтов на JS', {
  tag: 'h2',
  styles: {
    background: 'red',
    color: '#fff',
...
}), new _blocks.TextBlock('Это блок с текстом)', {
  styles: {
    'font-size': '16px',
    background: 'black',
    color: 'red',
...
}), new _blocks.ColumnsBlock(['Первая колонна', 'Вторая колонна', 'Третья колонна'], {
  styles: {
    background: 'purple',
    color: '#fff',
    padding: '2rem',
